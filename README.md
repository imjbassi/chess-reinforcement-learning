...
<div align="center">
  <img src="chess_rl.gif" alt="Chess-RL Demo" />
</div>
...
This project integrates a high-performance C++ chess engine with a PyTorch neural network, trained solely through self-play. By employing reinforcement learning, Chess-RL evolves its gameplay without relying on external chess expertise or predefined strategies.
...
<div align="center">
  <img src="Terminal.png" alt="Chess-RL Terminal Debug" width="420"/>
</div>
...
This project was inspired by DeepMind's AlphaZero and the broader research in game-playing AI through reinforcement learning.
